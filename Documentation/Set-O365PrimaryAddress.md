...
```
Set-O365PrimaryAddress [-msoluid] <Object> [-primary_address] <Object> [<CommonParameters>]
```
...
### -primary_address
Email address that should be set as the primary address on the account; must be a valid email address already assigned to the account (e.g.
foo@bar.wisc.edu)
