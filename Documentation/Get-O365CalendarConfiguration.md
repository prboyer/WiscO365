...
```
Get-O365CalendarConfiguration [[-include_metadata] <Object>] [[-request_params] <Object>]
...
### -include_metadata
If defined, the return value will include metadata
...
### -request_params
Parameters to get the calendar configuration for
...
### -resource_email
The email address of the resource for which to get configuration details
