...
### -msoluid
Unique ID of the account for which the password is being changed (e.g.
foo_bar)
...
### -password
\[Optional\] New password for the account; must meet password policy requirements. 
If no password is provided, a random password is generated and not returned.
