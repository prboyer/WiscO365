...
### -enable
Use '1' or anything that will evaluate to true to allow basic authentication, or 0, null, or any other false value to disallow basic auth
...
### -msoluid
Unique ID of the account for which to set Office 365 Basic Auth policy (e.g.
foo_bar)
