...
```
Get-O365AccountChangelog [[-change_types] <Object>] [-msoluid] <Object> [<CommonParameters>]
```
...
### -change_types
Optional comma-separated list of change keys (e.g.
create_account)
...
### -msoluid
Unique ID of the account for which to get change logs (e.g.
foo_bar)
...
### failure: null
### success: List of changes to an account with a change_type, change_description, and timestamp
## NOTES
