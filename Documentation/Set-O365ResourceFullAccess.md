...
```
Set-O365ResourceFullAccess [-delegate_account] <Object> [-resource_msoluid] <Object> [-set_type] <Object>
 [<CommonParameters>]
```
...
### -delegate_account
Account to receive or remove access from the resource
...
### -set_type
Defines whether permission is being added or removed, must be add or reomve
