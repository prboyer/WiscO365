...
```
Set-O365CalendarProcessing [-param_name] <Object> [-param_value] <Object> [-resource_email] <Object>
 [<CommonParameters>]
```
...
### -param_name
Value that will be set for the parameter supplied
...
### -param_value
Case-sensitive name of the parameter to set or change; use getCalendarProcessing with include_metadata to get acceptable values with parameter names
...
### -resource_email
Email address of the resource for which to change calendar processing configuration
