...
### -detail
\[Optional\] Will a complex response with additional details about the basic auth policy for this account
...
### -msoluid
Unique ID of the account for which to get Office 365 Basic Auth policy (e.g.
foo_bar)
...
### failure: null
### success: Returns the string 'Blocked' if Basic Authentication is disallowed, or the string 'Allowed' if Basic Authentication is allowed
## NOTES
