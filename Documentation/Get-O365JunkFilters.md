...
### -msoluid
Unique ID of the account for which to get junk mail filters (e.g.
foo_bar)
...
### failure: null
### success: enabled: 1|0, trust_contacts: 1|0, only_trust_lists: 1|0, trusted_senders: array of addresses or domains, blocked_senders: array of addresses or domains
## NOTES
